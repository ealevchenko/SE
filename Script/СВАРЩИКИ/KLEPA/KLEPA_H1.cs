...
namespace KLEPA_H1
{
    ...
    {
        // v1
        string NameObj = "[KLEPA_H1]";
        string NameCockpit = "[KLEPA_H1]-Промышленный кокпит [LCD]";
        string NameRemoteControl = "[KLEPA_H1]-ДУ парковка";
        string NameConnector = "[KLEPA_H1]-Коннектор парковка";
